...
//  FoodTracker
//
//  Created by Skyler Brown on 5/31/20.
//  Copyright © 2020 Skyler Brown. All rights reserved.
//
...
class MealViewController: UIViewController, UITextFieldDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    @IBAction func cancelButton(_ sender: UIBarButtonItem) {
        // Depending on the type of presentation (modal or push presentation), this view controller needs to be dismissed in two different ways.
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        /*
         ?? is nil coalescing operator; returns optional value if there is one,
